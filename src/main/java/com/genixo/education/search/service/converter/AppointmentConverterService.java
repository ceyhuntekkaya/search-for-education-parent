...
public class AppointmentConverterService {
    ...
    public AppointmentSlot mapToEntity(AppointmentSlotCreateDto dto) {
        if (dto == null) {
            return null;
        }

        AppointmentSlot entity = new AppointmentSlot();
        ...
        entity.setCapacity(ConversionUtils.defaultIfNull(dto.getCapacity(), 1));
        entity.setAppointmentType(dto.getAppointmentType());
        entity.setTitle(dto.getTitle());
        entity.setDescription(dto.getDescription());
        entity.setLocation(dto.getLocation());
        entity.setOnlineMeetingAvailable(ConversionUtils.defaultIfNull(dto.getOnlineMeetingAvailable(), false));
        entity.setPreparationRequired(ConversionUtils.defaultIfNull(dto.getPreparationRequired(), false));
        entity.setPreparationNotes(dto.getPreparationNotes());
        entity.setIsRecurring(ConversionUtils.defaultIfNull(dto.getIsRecurring(), true));
        entity.setValidFrom(dto.getValidFrom());
        entity.setValidUntil(dto.getValidUntil());
        entity.setExcludedDates(dto.getExcludedDates());
        entity.setAdvanceBookingHours(ConversionUtils.defaultIfNull(dto.getAdvanceBookingHours(), 24));
        entity.setMaxAdvanceBookingDays(ConversionUtils.defaultIfNull(dto.getMaxAdvanceBookingDays(), 30));
        entity.setCancellationHours(ConversionUtils.defaultIfNull(dto.getCancellationHours(), 4));
    ...
    public Appointment mapToEntity(AppointmentCreateDto dto) {
        if (dto == null) {
            return null;
        }
        ...
        entity.setDescription(dto.getDescription());
        entity.setLocation(dto.getLocation());
        entity.setIsOnline(ConversionUtils.defaultIfNull(dto.getIsOnline(), false));
        ...
        entity.setStudentBirthDate(dto.getStudentBirthDate());
