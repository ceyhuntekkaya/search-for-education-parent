...
//@Transactional(readOnly = true)
    ...
    public CampusDto mapToDto(Campus entity) {
        ...
        return CampusDto.builder()
                ...
                .isActive(entity.getIsActive())
                .createdAt(entity.getCreatedAt())
                .brand(mapToSummaryDto(entity.getBrand()))
    ...
    public SchoolDto mapToDto(School entity) {
        ...
        Set<CampaignSchool> campaigns = entity.getCampaignSchools();
...
// ceyhun tekkaya
              //  .activeCampaigns(campaignConverterService.mapToSummaryDto(List.copyOf(campaigns)))
