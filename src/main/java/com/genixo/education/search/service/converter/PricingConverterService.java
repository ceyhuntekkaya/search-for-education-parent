...
public class PricingConverterService {
    ...
    public SchoolPricingDto mapToDto(SchoolPricing entity) {
        ...
        return SchoolPricingDto.builder()
                ...
                // Custom fees
                .customFees(mapCustomFeesToDto(entity.getCustomFees()))
    ...
    public void updateEntity(SchoolPricingUpdateDto dto, SchoolPricing entity) {
        ...
        // Discount policies
        if (dto.getEarlyPaymentDiscountPercentage() != null) entity.setEarlyPaymentDiscountPercentage(dto.getEarlyPaymentDiscountPercentage());
        if (dto.getSiblingDiscountPercentage() != null) entity.setSiblingDiscountPercentage(dto.getSiblingDiscountPercentage());
        if (dto.getMultiYearDiscountPercentage() != null) entity.setMultiYearDiscountPercentage(dto.getMultiYearDiscountPercentage());
        ...
        if (dto.getLatePaymentPenaltyPercentage() != null) entity.setLatePaymentPenaltyPercentage(dto.getLatePaymentPenaltyPercentage());
    ...
    public CustomFee mapToEntity(CustomFeeCreateDto dto, SchoolPricing schoolPricing, User createdByUser) {
        if (dto == null) {
            return null;
        }

        CustomFee entity = new CustomFee();
        entity.setSchoolPricing(schoolPricing);
        entity.setCreatedByUser(createdByUser);
