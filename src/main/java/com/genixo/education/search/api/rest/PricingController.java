...
public class PricingController {
    ...
    @GetMapping("/custom-fees/pricing/{pricingId}")
    ...
    public ResponseEntity<ApiResponse<List<CustomFeeDto>>> getCustomFeesByPricing(
        ...
        log.debug("Get custom fees for pricing: {}", pricingId);

        List<CustomFeeDto> customFees = pricingService.getCustomFeesByPricing(pricingId, request);
