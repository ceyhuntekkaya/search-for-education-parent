...
public interface AppointmentSlotRepository extends JpaRepository<AppointmentSlot, Long> {
    ...
    @Query("SELECT a FROM AppointmentSlot a WHERE a.school.id = :schoolId " +
            "AND a.slotDate >= :startDateTime " +
            "AND a.slotDate < :endDateTime")
    List<AppointmentSlot> findByDateTimeRange(
